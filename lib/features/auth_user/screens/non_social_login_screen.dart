...
class NonSocialLoginScreen extends StatefulWidget {
  static const String SCREEN_ID = 'non_social_login_screen';

  @override
  _NonSocialLoginScreenState createState() => _NonSocialLoginScreenState();
}

class _NonSocialLoginScreenState extends State<NonSocialLoginScreen> {
  ScreenAwareSize sw;
                      ...
                      : FilledButton(
                          onPressed: () async {
                            ...
                            if (_formKey.currentState.validate()) {
                              ...
                              final _authResponse =
                                  await viewModel.completeNonSocialLoginProcess(
                                      email, password);
                              ...
                              if (_authResponse.success == true) {
                                ...
                                viewModel.userInitialProfileUpdated() == true
